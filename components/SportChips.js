...
const styles = StyleSheet.create({
  ...
  icon:        { fontSize: 14 },
  label:       { fontFamily: FONTS.bodyBold, color: COLORS.gray2, fontSize: 12, letterSpacing: 0.6, textTransform: 'uppercase' },
  labelActive: { color: COLORS.white, fontFamily: FONTS.bodyBold },
});
