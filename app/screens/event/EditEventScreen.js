  ...
  async function saveEvent() {
    ...
    try {
      ...
      const { error } = await supabase.from('events').update({
        ...
        cupos_hombres:        form.genero !== 'Mixto' || form.cupos_ilimitado ? null : form.cupos_hombres !== '' ? (parseInt(form.cupos_hombres) || 0) : undefined,
        cupos_mujeres:        form.genero !== 'Mixto' || form.cupos_ilimitado ? null : form.cupos_mujeres !== '' ? (parseInt(form.cupos_mujeres) || 0) : undefined,
