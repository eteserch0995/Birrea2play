...
const styles = StyleSheet.create({
  ...
  tabScroll:      { flexGrow: 0, minHeight: 52 },
  tabRow:         { paddingHorizontal: SPACING.md, paddingVertical: 4, gap: SPACING.sm, marginBottom: SPACING.sm, alignItems: 'center' },
  tab:            { paddingVertical: 10, paddingHorizontal: SPACING.md, borderRadius: RADIUS.md, backgroundColor: COLORS.card, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: COLORS.navy, minHeight: 40 },
  ...
  voteBtnText:    { fontFamily: FONTS.bodyBold, fontSize: 13, color: COLORS.bg, letterSpacing: 0.5 },
  // Jugadores
